...
export default function ManageMyAppointment({ values, onClose, reload } : Props) {
    ...
    return(
        <form onSubmit={handleSubmit} className="relative flex flex-col gap-6 p-4">
            ...
            <section className="flex flex-col gap-4">
                ...
                <TextInput value={data?.reason} required error={errors?.name} label="Motivo de la Cita" name="reason" />
                <TextAreaInput value={data.notes} name="notes" label="Notas adicionales" />
            </section>
