...
export default function DeleteMyAppointment({ values, onClose, reload} : Props) {
    ...
    return(
        <form onSubmit={handleSubmit} className="relative flex flex-col gap-6 p-4">
            ...
            <section className="flex flex-col gap-4">
                <p>¿Deseas eliminar esta cita médica? el médico continuará viendo tu cita como cancelada.</p>
            </section>
